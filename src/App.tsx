...
const BUILD_LABEL = "Verbal Comprehension Pathway v1 Alpha";
...
function LeverDebriefScreen({ journey, stage, onWhy, onDashboard, onNext }: { journey: MvpGuestJourney; stage: "guided" | "independent" | "assessment"; onWhy: () => void; onDashboard: () => void; onNext?: () => void }) {
  const debrief = getLatestDebrief(journey); const rec = getCurrentRecommendation(journey);
...
function AbstractLogicalDebriefScreen({ journey, stage, onWhy, onDashboard, onNext }: { journey: MvpGuestJourney; stage: AbstractLogicalStage; onWhy: () => void; onDashboard: () => void; onNext?: () => void }) {
  const debrief = getLatestDebrief(journey);
  const rec = getCurrentRecommendation(journey);
...
function VerbalDebriefScreen({ journey, stage, onWhy, onDashboard, onNext }: { journey: MvpGuestJourney; stage: VerbalStage; onWhy: () => void; onDashboard: () => void; onNext?: () => void }) {
  const debrief = getLatestDebrief(journey);
  const rec = getCurrentRecommendation(journey);

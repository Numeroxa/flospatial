...
const BUILD_LABEL = "Prototype Zero Hydraulic Journey v1 Alpha";
...
const hydraulicIndependentPracticeQuestions: MvpQuestion[] = [
  makeHydraulicIndependentQuestion("HYD-IP-001", "pressure_transfer", "In an ideal sealed hydraulic system, what happens to pressure applied at the input piston?", ["It is transmitted through the fluid", "It remains only under the input piston", "It disappears before reaching the output", "It acts only if air enters the system"], "A", "Pressure applied to a confined fluid is transmitted through the system."),
  makeHydraulicIndependentQuestion("HYD-IP-002", "piston_area_force", "The same pressure acts on two pistons. One piston has three times the area of the other. Which produces the greater force?", ["The larger piston, with three times the force", "The smaller piston, with three times the force", "Both produce the same force", "Neither piston produces force"], "A", "At the same pressure, force increases in proportion to piston area."),
  makeHydraulicIndependentQuestion("HYD-IP-003", "force_ratio", "A 120 N force acts on a 2 cm² input piston. The output piston area is 10 cm². What is the ideal output force?", ["600 N", "240 N", "1200 N", "24 N"], "A", "The output area is five times larger, so the ideal output force is five times larger: 600 N."),
  makeHydraulicIndependentQuestion("HYD-IP-004", "movement_direction", "The left piston in a simple sealed two-piston system is pushed downward. What will the right piston usually do?", ["Move upward", "Move downward", "Remain fixed", "Move only if fluid is removed"], "A", "The input piston displaces fluid, which usually drives the other piston upward."),
  makeHydraulicIndependentQuestion("HYD-IP-005", "force_distance_tradeoff", "A hydraulic system gives a four-to-one force advantage. Ideally, how far must the input piston move compared with the output piston?", ["Four times as far", "One-quarter as far", "The same distance", "Distance is unrelated to force advantage"], "A", "A four-to-one force advantage requires roughly four times the input movement distance."),
  makeHydraulicIndependentQuestion("HYD-IP-006", "applied_jack", "Why can a hydraulic jack lift a heavy vehicle using a smaller input force?", ["Pressure is transmitted through the fluid and acts over a larger output area", "The fluid removes the vehicle's weight", "The handle creates energy from nothing", "The output piston receives less pressure"], "A", "Transmitted pressure acting over a larger output piston area produces greater force."),
];

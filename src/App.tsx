...
function DashboardScreen({
  ...
  return <Shell right={timing}><section className="mx-auto max-w-6xl px-6 py-10 sm:px-8 sm:py-12">
    ...
    {SHOW_TEST_SCENARIOS && <details className="mt-6 rounded-2xl border border-white/5 bg-[#151A21] p-5"><summary className="cursor-pointer text-sm font-medium text-[#8D98A6]">Tester tools</summary><div className="mt-5"><div className="mb-5 flex flex-col gap-3 sm:flex-row"><SecondaryButton onClick={onOpenFluencyAnalytics}>Open fluency analytics</SecondaryButton><SecondaryButton onClick={onReset}>Reset local journey</SecondaryButton></div><TestScenarioPanel onLoad={onLoadTestScenario} /></div></details>}
  </section></Shell>;
}

...
export const MECHANICAL_CALIBRATION_PILOT_VERSION = "APTESTA_MECH_CAL_PILOT_2026_08_V0_7";
...
export const mechanicalCalibrationPilotItems: MechanicalCalibrationPilotItem[] = [
  ...
  },
  {
    ...
    rapidRecognition: true,
    stem: "Ignoring friction, a 200 N load is supported by the two rope strands shown. What downward effort is needed to hold the load steady?",
    options: [
  ...
  },
  {
    ...
    targetTimeRangeSec: { minSec: 35, maxSec: 40 },
    rapidRecognition: true,
    stem: "Ignoring friction, a 400 N load is supported by four rope strands. What effort is needed to hold it steady?",
    options: [
      { optionId: "A", text: "50 N" },
      { optionId: "B", text: "100 N" },
      { optionId: "C", text: "200 N" },

...
export const mechanicalCalibrationPilotItems: MechanicalCalibrationPilotItem[] = [
  ...
  },
  {
    ...
    targetTimeRangeSec: { minSec: 35, maxSec: 45 },
    rapidRecognition: false,
    stem: "A block rests freely on a trolley. It is not attached to the trolley, and friction is negligible. The trolley suddenly accelerates to the right. Relative to the trolley, which way does the block initially move?",
    options: [
      { optionId: "A", text: "Left" },
      { optionId: "B", text: "Right" },

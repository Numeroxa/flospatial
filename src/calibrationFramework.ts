...
export const GENERAL_CALIBRATION_BLUEPRINT_VERSION = "APTESTA_GENERAL_CAL_BLUEPRINT_2026_08_V0_6";
...
export const generalCalibrationBlueprints: GeneralCalibrationBlueprint[] = [
  ...
  b("mechanical", 2, "Gear speed ratio", "gear_speed_ratio", "Two gears, tooth counts shown; ask output rpm.", "Diagram MCQ", 40, 50, "applied", "Check concise ratio reasoning without instructional prose.", "candidate", "qa_review", "in_review"),
  b("mechanical", 3, "Compound gears", "compound_gear_speed", "Two gears share a shaft within a four-gear train.", "Diagram MCQ", 45, 55, "stretch", "Add multi-stage speed reasoning.", "no", "qa_review", "in_review"),
  b("mechanical", 4, "Belt drive direction", "open_belt_direction", "Open belt between two pulleys; ask driven direction.", "Diagram MCQ", 30, 35, "foundation", "Fill FRV wheels/belts gap.", "yes", "qa_review", "in_review"),
  b("mechanical", 5, "Crossed belt direction", "crossed_belt_direction", "Crossed belt; ask driven direction.", "Diagram MCQ", 30, 35, "applied", "Distinguish open vs crossed belt.", "yes", "qa_review", "in_review"),
  b("mechanical", 6, "Pulley mechanical advantage", "pulley_supporting_strands", "Moving pulley block; count supporting strands.", "Diagram MCQ", 35, 40, "foundation", "Retain current strength; speed recognition.", "yes"),
  b("mechanical", 7, "Pulley distance trade-off", "pulley_distance_tradeoff", "Load rises 0.5 m with four supports; ask rope travel.", "Diagram MCQ", 40, 45, "applied", "Test force-distance relationship."),
  b("mechanical", 8, "Lever moments", "lever_moment_balance", "Load/effort arms labelled; ask effort force.", "Diagram MCQ", 40, 50, "applied", "Retain current strength with corrected arm arrows."),
  b("mechanical", 9, "Lever fulcrum shift", "lever_fulcrum_shift", "Same lever before/after fulcrum movement; ask effect on effort.", "Diagram MCQ", 35, 40, "applied", "Reason qualitatively rather than calculate.", "candidate"),
  b("mechanical", 10, "Hydraulic force", "hydraulic_force_area", "Two piston areas; input force given; ask output force.", "Diagram MCQ", 45, 55, "applied", "Retain current pressure/area strength."),
  b("mechanical", 11, "Hydraulic movement", "hydraulic_volume_displacement", "Small piston moves given distance; ask large piston movement.", "Diagram MCQ", 45, 55, "stretch", "Add volume conservation, not only force."),
  b("mechanical", 12, "Linked bars", "linked_bar_motion", "Two pivoted bars linked by a connector; ask motion of second end.", "Diagram MCQ", 35, 45, "applied", "Fill FRV linked-bars gap.", "candidate"),
  b("mechanical", 13, "Bell crank / linkage", "bell_crank_direction", "Right-angle linkage changes direction of movement.", "Diagram MCQ", 35, 45, "applied", "Rapid cause-and-effect recognition.", "yes"),
  b("mechanical", 14, "Inclined plane", "inclined_plane_force", "Compare force required on two ramps reaching same height.", "Diagram MCQ", 35, 45, "foundation", "Broaden simple machines."),
  b("mechanical", 15, "Wheel and axle", "wheel_axle_advantage", "Different radii; ask which arrangement gives greater mechanical advantage.", "Diagram MCQ", 35, 45, "applied", "Fill wheels/simple-machines coverage."),
  b("mechanical", 16, "Force / friction", "friction_start_force", "Same block on two surfaces; ask which needs more force to start.", "Diagram MCQ", 30, 40, "foundation", "Fill forces/motion gap.", "candidate"),
  b("mechanical", 17, "Centre of mass / stability", "stability_base_height", "Three objects with different base/height; ask most stable.", "Diagram MCQ", 30, 40, "applied", "Useful practical physics style.", "candidate"),
  b("mechanical", 18, "Acceleration / inertia", "trolley_inertia", "Object on trolley during sudden acceleration; ask relative motion.", "Diagram MCQ", 35, 45, "applied", "Fill forces/motion gap."),
  b("mechanical", 19, "3D mechanical visualisation", "mechanical_view_rotation", "Simple shaft/handle arrangement viewed from another angle.", "Spatial-mech MCQ", 45, 60, "stretch", "Directly address FRV 3D visualisation."),
  b("mechanical", 20, "Integrated machine", "integrated_machine_motion", "Gear drives pulley/lever or linkage; ask final motion.", "Diagram MCQ", 50, 60, "stretch", "Test method selection under realistic complexity."),

  // Numerical — 20
  b("numerical", 1, "Mental arithmetic", "mental_arithmetic_two_step", "Two-step arithmetic with friendly numbers.", "MCQ", 35, 45, "foundation", "Criteria-style speed baseline.", "candidate"),
  b("numerical", 2, "Estimate", "numeric_estimation", "Choose closest estimate for multiplication/division.", "MCQ", 30, 40, "foundation", "Rapid plausibility check.", "yes"),
  b("numerical", 3, "Percentage of quantity", "percentage_of_quantity", "Calculate 15% or 12.5% of practical value.", "MCQ", 40, 50, "foundation", "Retain current strength."),
  b("numerical", 4, "Percentage change", "percentage_change", "Original/final values; ask percentage increase/decrease.", "MCQ", 45, 60, "applied", "Test denominator choice."),
  b("numerical", 5, "Ratio sharing", "ratio_sharing", "Divide total in 2:3:5 ratio.", "MCQ", 45, 60, "applied", "Retain current strength."),
  b("numerical", 6, "Direct rate", "direct_rate", "Distance/time or flow/time.", "MCQ", 40, 50, "foundation", "Retain current strength."),
  b("numerical", 7, "Inverse work rate", "inverse_work_rate", "Workers/pumps and fixed job duration.", "MCQ", 50, 65, "applied", "Retain newly taught inverse-rate method."),
  b("numerical", 8, "Average", "missing_value_average", "Find missing value from average.", "MCQ", 45, 55, "applied", "Criteria-style math/logic."),

...
export const generalCalibrationBlueprints: GeneralCalibrationBlueprint[] = [
  ...
  b("abstract_logical", 12, "Analogy - fill change", "analogy_fill_change", "Filled becomes outline while shape retained.", "Visual analogy", 40, 55, "foundation", "Simple one-rule analogy.", "candidate", "pilot_live", "cleared", "analogy_fill_change_v1"),
  b("abstract_logical", 13, "Deduction - ordering", "deduction_ordering", "Three/four entities with before/after constraints.", "Text logic MCQ", 45, 60, "applied", "FENZ deductive component.", "no", "pilot_live", "cleared", "deduction_ordering_v1"),
